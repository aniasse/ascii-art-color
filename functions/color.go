...
func Supported(c string) bool {
	if c == "black" || c == "white" || c == "red" || c == "green" || c == "blue" || c == "yellow" || c == "cyan" || c == "silver" || c == "grey" || c == "chartreuse" || c == "brown" || c == "purple" || c == "gold" || c == "pink" || c == "salmon" || c == "olive" || c == "turquoise" || c == "dark-grey" || c == "yellow-green" || c == "navy-blue" || c == "fucshia" || c == "olive-green" || c == "saffron" || c == "sky-blue" || c == "dark-red" {
		return true
	} else if c == "rgb(0, 0, 0)" || c == "rgb(0, 255, 0)" || c == "rgb(255, 0, 0)" || c == "rgb(255, 255, 0)" || c == "rgb(0, 0, 255)" || c == "rgb(0, 255, 255)" || c == "rgb(255, 255, 255)" || c == "rgb(192, 192, 192)" || c == "rgb(128, 128, 128)" || c == "rgb(154, 205, 50)" || c == "rgb(165, 42, 42)" || c == "rgb(128, 0, 128)" || c == "rgb(255, 215, 0)" || c == "rgb(255, 192, 203)" || c == "rgb(250, 128, 114)" || c == "rgb(128, 128, 0)" || c == "rgb(64, 224, 208)" || c == "rgb(64, 64, 64)" || c == "rgb(127, 255, 0)" || c == "rgb(0, 0, 128)" || c == "rgb(255, 0, 255)" || c == "rgb(85, 107, 47)" || c == "rgb(244, 196, 48)" || c == "rgb(135, 206, 235)" || c == "rgb(139, 0, 0)" {
		return true
	} else if c == "#000000" || c == "#00ff00" || c == "#ff0000" || c == "#ffff00" || c == "#0000ff" || c == "#00ffff" || c == "#ffffff" || c == "#c0c0c0" || c == "#808080" || c == "#7fff00" || c == "#a52a2a" || c == "#800080" || c == "#ffd700" || c == "#ffc0cb" || c == "#fa8072" || c == "#808000" || c == "#40e0d0" || c == "#404040" || c == "#9acd32" || c == "#000080" || c == "#ff00ff" || c == "#556b2f" || c == "#f4c430" || c == "#87ceeb" || c == "#8b0000" {
		return true
